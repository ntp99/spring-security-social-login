...
import com.example.social.security.UserPrincipal;
import com.example.social.repositories.UserRepository;
import com.example.social.security.oauth2.user.OAuth2UserInfo;
import com.example.social.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
	...
	@Bean
	public OAuth2VerificationService oAuth2VerificationService() {
		return new OAuth2VerificationService();
	}
